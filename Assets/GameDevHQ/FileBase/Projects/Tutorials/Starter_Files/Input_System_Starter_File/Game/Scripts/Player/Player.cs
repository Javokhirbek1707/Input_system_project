...
namespace Game.Scripts.Player
{
    ...
    public class Player : MonoBehaviour
    {
        ...
        private PlayerAction _input; //for Initiliaze Input System
        ...
        private void Start()
        {
            ...
            PlayerInputInitialized();//Initiliaze player actions
        ...
        private void PlayerInputInitialized()//Initiliaze player actions
        {
        ...
        private void CalcutateMovement()
        {
            ...
            Vector2 movement = _input.Player.Movement.ReadValue<Vector2>();//player movement
