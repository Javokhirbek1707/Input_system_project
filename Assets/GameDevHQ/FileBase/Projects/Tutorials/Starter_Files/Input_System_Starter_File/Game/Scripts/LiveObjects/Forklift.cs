...
namespace Game.Scripts.LiveObjects
{
    public class Forklift : MonoBehaviour
    {
        ...
        private InputManagerScript _inputManager;//for Input Manager
        ...
        private void EnterDriveMode(InteractableZone zone)
        {
            if (_inDriveMode !=true && zone.GetZoneID() == 5) //Enter ForkLift
            {
                ...
                _inputManager.InitializeForkliftInput();//Initialize forklift here
            }
        }
        ...
        {
            Debug.Log("It's working");//this for checking
        }
        ...
        public void LiftRoutine(float liftInput)//For Lift control
        {
            Vector3 tempPos = _lift.transform.localPosition;
            tempPos.y += liftInput * Time.deltaTime * _liftSpeed;
            tempPos.y = Mathf.Clamp(tempPos.y, _liftLowerLimit.y, _liftUpperLimit.y); //Clamp range
